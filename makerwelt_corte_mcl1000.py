#!/usr/bin/env python
"""
Modified by gsoto 2017, Maker-Welt.com,
modified by Adam Polak 2014, polakiumengineering.org

based on Copyright (C) 2017 gsoto, guillermo.soto@utec.edu.pe
...
################################################################################
    def orientation(self, layer=None) :
        ...
        viewbox = self.document.getroot().xpath('@viewBox', namespaces=inkex.NSS)[0].split()
        viewbox_height = self.unittouu(viewbox[3])

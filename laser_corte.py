...
class GcodeExport(inkex.Effect):
    ...
    def effect(self):
        ...
        if (os.path.isdir(self.options.directory)) == True:
            ...
            pos_file_png_BW = os.path.join(self.options.directory, self.options.filename + suffix + "nuevo.png")
    ...
    def PNGtoGcode(self, pos_file_png_exported, pos_file_png_BW, pos_file_gcode):
        ...
        if self.options.preview_only == False:  # Genero Gcode solo se devo
            ...
            file_gcode.write('; Generado con:\n; "Generador de raster para MCL1000"\n; by Maker-Welt\n;\n')
            # HOMING
            ...
            file_gcode.write('M117 Trabajo en proceso...; LCD \n')
            ...
            file_gcode.write('G18; Disable motors\n')
